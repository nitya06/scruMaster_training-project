class UrlMappings {
	...
	static mappings = {
       ...
       "/project"(controller: "project", parseRequest: true)
        ...
        "/getPageCountForAllTask"(controller: "task", parseRequest: true)
        {
             action = [GET: "getPageCountForAllTask"]
            
        }
        "/fetchAllTaskForSpecificProject"(controller: "task", parseRequest: true)
        {
             action = [GET: "fetchAllTaskForSpecificProject"]
        ...
        "/getPageCountForUserStoryInSprintBoard"(controller: "userStory", parseRequest: true)
        {
              action = [GET: "getPageCountForUserStoryInSprintBoard"]
        }
        
        "/fetchTaskInfo"(controller: "task", parseRequest: true)
        {
              action = [GET: "fetchTaskInfo"]
        }
        
        
        "/updateTaskFromAllTask"(controller: "task", parseRequest: true)
        {
              action = [PUT: "updateTaskFromAllTask"]
        }
