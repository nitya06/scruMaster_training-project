...
class gsp_iceScrumresetPassword_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/resetPassword.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',83,['controller':("Users"),'action':("setPassword"),'onsubmit':("return ValidateUserRecord();")],2)
printHtmlPart(12)
})
...
public static final long LAST_MODIFIED = 1379914776000L
